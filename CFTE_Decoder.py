...
if __name__ == "__main__":
    ...
    if encoder_type == 'FOMM':
        FOMM2CFTE_checkpoint_path='./GFVC/Translator/checkpoint/FOMM2CFTE_checkpoint.pth.tar'      
        trans_enc = load_FOMM_Enc_translator(FOMM2CFTE_checkpoint_path, cpu=False)
        trans_dec = load_CFTE_Dec_translator(FOMM2CFTE_checkpoint_path, cpu=False)
        ## FOMM
    ...
    if encoder_type == 'FV2V':
        FV2V2CFTE_checkpoint_path='./GFVC/Translator/checkpoint/FV2V2CFTE_checkpoint.pth.tar'      
        trans_enc = load_FV2V_Enc_translator(FV2V2CFTE_checkpoint_path, cpu=False)
        trans_dec = load_CFTE_Dec_translator(FV2V2CFTE_checkpoint_path, cpu=False)
        ## FV2V
        ...
        if frame_idx in [0]:      # I-frame                      
            ...
            with torch.no_grad(): 
                ...
                if encoder_type == 'CFTE':
                    ...
                    raise ValueError('Invalid encoder type, support CFTE, FOMM and FV2V')
            ...
            if encoder_type == 'CFTE':
                ...
                kp_current_value = trans_dec(trans_enc(kp_current_value, kp_current_jocobi)).unsqueeze(0)
            elif encoder_type == 'FV2V':   
                ...
                kp_current_value = trans_dec(trans_enc(kp_current_exp, kp_current_mat, kp_current_t)).unsqueeze(0)
